...
process.env.FAUCET_PRIVATE_KEY =
  'a3a0263c585ba8f7eb37fefaee001383b09cc6897965096aa0f52d12ea88e8b901';
...
describe('faucet', () => {
  ...
  test('sends from the correct address', async () => {
    ...
    const addr = Address.fromPublicKeys(0, AddressHashMode.SerializeP2PKH, 1, [
      new StacksPublicKey(pubKey.toString()),
    ]);
