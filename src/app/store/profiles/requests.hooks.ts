...
const updateProfileRequestToken = atom<null | string>(null);

export function useSetAtomUpdateProfileRequestToken(requestToken: null | string) {
  const [_, setTokenValue] = useAtom(updateProfileRequestToken);
...
export function useIsUpdateProfileRequestValid() {
...
function createTestRequest() {
  ...
  const payload = Object.assign({}, {
    profile: {
      name: "Friedger", image: [{ "@type": "ImageObject", name: "avatar", contentUrl: "https://github.com/friedger.png" }]
    },
...
export function useUpdateProfileRequestSearchParams() {
