...
export async function fetchSuppliers({ network, magicClient, magicContracts, electrumClient }: MagicFetchContextWithElectrum): Promise<MagicSupplierWithCapacity[]> {
