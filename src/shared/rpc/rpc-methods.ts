...
import { HandleBitcoinContractMethod } from './methods/handle-bitcoin-contract-method';
...
export type WalletMethodMap = BtcKitMethodMap & SupportedMethods & SignPsbt & HandleBitcoinContractMethod;
