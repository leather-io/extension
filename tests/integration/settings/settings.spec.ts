...
describe(`Settings integration tests`, () => {
  ...
  it('should be able to create a new account', async () => {
    ...
    await delay(500);
    await wallet.page.waitForSelector(SettingsSelectors.CurrentAccountDisplayName);
  ...
  it.only(`should be able to create ${numOfAccountsToTest} new accounts then switch between them`, async () => {
