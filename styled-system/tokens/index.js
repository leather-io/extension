const tokens = {
  ...
  "colors.primary.50": {
    "value": "hsl(var(--nextra-primary-hue) 100% 97%)",
    "variable": "var(--colors-primary-50)"
  },
  "colors.primary.100": {
    "value": "hsl(var(--nextra-primary-hue) 100% 94%)",
    "variable": "var(--colors-primary-100)"
  },
  "colors.primary.200": {
    "value": "hsl(var(--nextra-primary-hue) 100% 86%)",
    "variable": "var(--colors-primary-200)"
  },
  "colors.primary.300": {
    "value": "hsl(var(--nextra-primary-hue) 100% 77%)",
    "variable": "var(--colors-primary-300)"
  },
  "colors.primary.400": {
    "value": "hsl(var(--nextra-primary-hue) 100% 66%)",
    "variable": "var(--colors-primary-400)"
  },
  "colors.primary.500": {
    "value": "hsl(var(--nextra-primary-hue) 100% 50%)",
    "variable": "var(--colors-primary-500)"
  },
  "colors.primary.600": {
    "value": "hsl(var(--nextra-primary-hue) 100% 45%)",
    "variable": "var(--colors-primary-600)"
  },
  "colors.primary.700": {
    "value": "hsl(var(--nextra-primary-hue) 100% 39%)",
    "variable": "var(--colors-primary-700)"
  },
  "colors.primary.750": {
    "value": "hsl(var(--nextra-primary-hue) 100% 35%)",
    "variable": "var(--colors-primary-750)"
  },
  "colors.primary.800": {
    "value": "hsl(var(--nextra-primary-hue) 100% 32%)",
    "variable": "var(--colors-primary-800)"
  },
  "colors.primary.900": {
    "value": "hsl(var(--nextra-primary-hue) 100% 24%)",
  ...
  "colors.bg.main": {
    "value": "var(--colors-bg-main)",
    "variable": "var(--colors-bg-main)"
  },
  "colors.bg.muted": {
  ...
  "colors.bg.dark": {
    "value": "var(--colors-bg-dark)",
    "variable": "var(--colors-bg-dark)"
  },
  "colors.bg.inverted": {
  ...
  "colors.bg.emphasized.hover": {
    "value": "var(--colors-bg-emphasized\\.hover)",
    "variable": "var(--colors-bg-emphasized\\.hover)"
  },
  "colors.text.main": {
    "value": "var(--colors-text-main)",
    "variable": "var(--colors-text-main)"
  },
  "colors.text.headline": {
    "value": "var(--colors-text-headline)",
    "variable": "var(--colors-text-headline)"
  },
  "colors.text.muted": {
  ...
  "colors.colorPalette.main": {
    "value": "var(--colors-color-palette-main)",
    "variable": "var(--colors-color-palette-main)"
  },
  ...
  "colors.colorPalette.emphasized.hover": {
    "value": "var(--colors-color-palette-emphasized-hover)",
    "variable": "var(--colors-color-palette-emphasized\\.hover)"
  },
